      ...
      <div class="relative inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
        ...
        <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          <div class="flex items-center justify-between">
            ...
            <button
              type="button"
              class="bg-white dark:bg-gray-800 rounded-md text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              @click="$emit('close')"
            >
        ...
        <!-- Content -->
        <div class="bg-white dark:bg-gray-800 px-4 pt-0 pb-4 sm:p-6 sm:pt-0">
          <div class="grid grid-cols-1 gap-6">
            <div class="text-center py-12">
              ...
              <p class="text-sm text-gray-500 dark:text-gray-500 mt-2">
                This includes themes, notifications, and account preferences.
              </p>
            </div>
          </div>
        </div>
